...
public class InitDatabase {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        query = "CREATE TABLE Employee "
                ...
                + " FOREIGN KEY (C_id) REFERENCES Company_card(id),"
                + " PRIMARY KEY (id))";
        stmt.execute(query);
        ...
        query = "CREATE TABLE Transaction "
                ...
                + " FOREIGN KEY (C_name) REFERENCES Company_card(name),"
                + " FOREIGN KEY (I_name) REFERENCES Individual_card(name),"
                + " FOREIGN KEY (D_name) REFERENCES Dealer_card(name),"
