                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <input type="radio" id="blood_yes" name="blood" value="Yes" checked>Yes
                                <input type="radio" id="blood_no" name="blood" value="No">No
                        ...
                        <tr>
                            <th style="text-align: right;"><label for="type_of_blood"><b>Type of blood:</b></label></th>
                            <th>
                        ...
                        <tr>
                            ...
                            <th>
                                <button id="button_bottom" type="submit" class="fill">Register</button>
                            </th>
                            <th>
                                <!--empty on purpose-->
                            </th>
