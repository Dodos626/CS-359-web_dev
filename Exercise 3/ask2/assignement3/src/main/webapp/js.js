...
function submit_form_to_Server(e) {
  ...
  xhr.onload = function () {
    if (xhr.readyState === 4 && xhr.status === 201) {
      ...
      print_registration(JSON.parse(xhr.responseText))
...
function print_registration(obj){
  let string ="<tr><td>email:</td><td>"+obj.email+"</td></tr>"
  string +="<tr><td>usernane:</td><td>"+obj.username+"</td></tr>"
  string +="<tr><td>amka:</td><td>"+obj.amka+"</td></tr>"
  string +="<tr><td>birthdate:</td><td>"+obj.birthdate+"</td></tr>"
  string +="<tr><td>address:</td><td>"+obj.address+"</td></tr>"
  string +="<tr><td>bloodtype:</td><td>"+obj.bloodtype+"</td></tr>"
  string +="<tr><td>city:</td><td>"+obj.city+"</td></tr>"
  string +="<tr><td>first name:</td><td>"+obj.firstname+"</td></tr>"
  string +="<tr><td>last name:</td><td>"+obj.lastname+"</td></tr>"
  string +="<tr><td>gender:</td><td>"+obj.gender+"</td></tr>"
  string +="<tr><td>height:</td><td>"+obj.height+"</td></tr>"
  string +="<tr><td>weight:</td><td>"+obj.weight+"</td></tr>"
  string +="<tr><td>telephone:</td><td>"+obj.telephone+"</td></tr>"
  string +="<tr><td>please login :</td><td><a href='login.html'>login</a> </td></tr>"
  ...
  document.getElementById("first_table").innerHTML=string
}